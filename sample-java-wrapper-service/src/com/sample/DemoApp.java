...
public class DemoApp implements WrapperListener
{
    ...
    private DemoApp()
    {
        ...
        m_confFile = "../conf/mydemoapp.conf";
    ...
    private Process callAction( String action ) throws IOException
    {
        ...
        if ( action.equals( "mail" ) )
        {
            ...
            if ( md.getResult() != 0 )
            {
                ...
                {
                    wrapperBin = "/home/cjrequena/Development/workspaces/ws_samples/sample-java-wrapper-service/wrapper-linux-x86-64-3.5.26/bin/wrapper";
                }
