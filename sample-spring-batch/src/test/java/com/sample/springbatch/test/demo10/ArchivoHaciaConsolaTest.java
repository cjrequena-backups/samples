package com.sample.springbatch.test.demo10;
...
/**
 * Este test se encarga de mostrar la ejecución del paquete "demo10".
...
@ContextConfiguration(locations = {
    "classpath:jobs/demo10/spring-batch-demo.xml"
})
public class ArchivoHaciaConsolaTest {
    ...
    public void iniciarJob() throws Exception {
        ...
        //builder.addString("input.file.name", "file:///home/carlos/Temporal/planetas.csv");
